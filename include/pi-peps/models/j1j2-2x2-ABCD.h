...
namespace itensor {
  ...
  // ----- Definition of model base class and its particular instances --
  class J1J2Model_2x1_AB : public Model {
   public:
    double J1, J2, del;

    J1J2Model_2x1_AB(double arg_J1, double arg_J2, double arg_del);
  ...
  // ----- Definition of model base class and its particular instances --
  class J1J2Model_1x1_A_ROT : public Model {
   public:
    double J1, J2, del;

    J1J2Model_1x1_A_ROT(double arg_J1, double arg_J2, double arg_del);
