...
void applyH_123_v3(MPO_3site const& mpo3s,
                   ...
                   itensor::ITensor& l12,
                   itensor::ITensor& l23,
                   itensor::ITensor& l12I,
                   itensor::ITensor& l23I,
                   bool dbg = false);

// ----- 3-Site operator functions ------------------------------------

itensor::Args simpleUpdate(MPO_2site const& u12,
                           Cluster& cls,
                           std::vector<std::string> tn,
                           std::vector<int> pl,
                           itensor::Args const& args = itensor::Args::global());

itensor::Args simpleUpdate(MPO_3site const& u123,
                           Cluster& cls,
                           std::vector<std::string> tn,
                           std::vector<int> pl,
                           itensor::Args const& args = itensor::Args::global());

itensor::Args simpleUpdate(OpNS const& u12,
                           Cluster& cls,
                           std::vector<std::string> tn,
                           std::vector<int> pl,
                           itensor::Args const& args = itensor::Args::global());
