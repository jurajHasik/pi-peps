...
int main(int argc, char* argv[]) {
  ...
  std::cout << "T: "
            ...
            << " [sec]" << std::endl;
  for (int i = 1; i <= 5; i++)
    std::cout << S_l1.real(S_l1.inds().front()(i), S_l1.inds().back()(i))
              << std::endl;
  ...
  // S_l1.real(S_l1.inds().front()(i),S_l1.inds().back()(i)) << std::endl;
  ...
  std::cout << "T: "
            ...
            << " [sec]" << std::endl;
  for (int i = 1; i <= 5; i++)
    std::cout << S_l.real(S_l.inds().front()(i), S_l.inds().back()(i))
              << std::endl;
  ...
  //     <<" [sec]"<< std::endl;
  // for (int i=1;i<=5;i++) std::cout<<
  // S_l3.real(S_l3.inds().front()(i),S_l3.inds().back()(i)) << std::endl;
  ...
  //     <<" [sec]"<< std::endl;
  // for (int i=1;i<=5;i++) std::cout<<
  // S_l.real(S_l.inds().front()(i),S_l.inds().back()(i)) << std::endl;
  ...
  std::cout << "Norm Approx itensor svd: " << norm(U_l1 * S_l1 * V_l1)
            << std::endl;
  std::cout << "Diff-norm itensor svd: " << norm(largeT - U_l1 * S_l1 * V_l1)
            << std::endl;
  std::cout << "Norm Approx rsvd: " << norm(U_l * S_l * V_l) << std::endl;
  std::cout << "Diff-norm itensor svd: " << norm(largeT - U_l * S_l * V_l)
            << std::endl;
