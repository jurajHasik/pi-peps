...
void getModel_NNHLadder(nlohmann::json & json_model,
    ...
    std::string arg_fuGateSeq = json_model["fuGateSeq"].get<std::string>();
  	...
  	gateMPO.push_back( getMPO3s_Uladder(arg_tau, arg_J1, arg_J1) );
    gateMPO.push_back( getMPO3s_Uladder(arg_tau, arg_J1, arg_alpha*arg_J1) );
    //MPO_3site uJpJ(getMPO3s_Uladder(arg_tau, alpha*arg_J1, arg_J1));
