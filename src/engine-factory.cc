...
EngineFactory::EngineFactory() {
  ...
  registerEngine("HB_2X2_ABCD",
                 &itensor::HeisenbergModel_2x2_ABCD::buildEngine);
  ...
  registerEngine("LADDERS_2X2_ABCD",
                 &itensor::LaddersModel_2x2_ABCD::buildEngine);
  registerEngine("LADDERS_4X2_ABCD",
                 &itensor::LaddersModel_4x2_ABCD::buildEngine);
}
