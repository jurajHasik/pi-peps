...
namespace itensor {
  ...
  std::unique_ptr<Model> IdentityModel_2x2_ABCD::create(
  ...
  std::unique_ptr<Engine> IdentityModel_2x2_ABCD::buildEngine(
    nlohmann::json& json_model) {
    ...
    if (arg_fuGateSeq == "2SITE") {
      ...
      std::cout << "IdentityModel_2x2_ABCD 2SITE ENGINE constructed"
                << std::endl;
      if (arg_symmTrotter)
        pe->td.symmetrize();
      ...
      std::cout << "IdentityModel_2x2_ABCD SYM3 ENGINE constructed"
                << std::endl;
      if (arg_symmTrotter)
        pe->td.symmetrize();
      return std::unique_ptr<Engine>(pe);
      ...
      std::cout << "IdentityModel_2x2_ABCD 4SITE ENGINE constructed"
                << std::endl;
      if (arg_symmTrotter)
        pe->td.symmetrize();
      return std::unique_ptr<Engine>(pe);
  ...
  std::unique_ptr<Model> IdentityModel_2x2_AB::create(
    nlohmann::json& json_model) {
    auto arg_physDim = json_model["physDim"].get<int>();
  ...
  std::unique_ptr<Engine> IdentityModel_2x2_AB::buildEngine(
    nlohmann::json& json_model) {
    // symmetrize Trotter Sequence
    bool arg_symmTrotter = json_model.value("symmTrotter", false);
    auto arg_physDim = json_model["physDim"].get<int>();
