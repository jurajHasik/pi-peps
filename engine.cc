...
// std::unique_ptr<Model> buildModel(nlohmann::json & json_model) {

//     std::string arg_modelType = json_model["type"].get<std::string>(); 

//     if (arg_modelType == "J1J2") {
//         return getModel_J1J2(json_model);
//     // } else if (arg_modelType == "NNN") {
//     //     // nearest-to-nearest neighbour model
//     //     getModel_3site(json_model, ptr_model, gateMPO, ptr_gateMPO, gates, gate_auxInds);
//     // } else if (arg_modelType == "PLAQUETTE") {
//     //     getModel_4site(json_model, ptr_model, gateMPO, ptr_gateMPO, gates, gate_auxInds);
//     } else {
//         std::cout<<"Unsupported model: "<< arg_modelType << std::endl;
//         exit(EXIT_FAILURE);
//     }
...
template<> Args TrotterEngine<MPO_2site>::performFullUpdate(
    ...
    return fullUpdate_2site_PINV(*td.ptr_gateMPO[gi], cls, ctmEnv,
