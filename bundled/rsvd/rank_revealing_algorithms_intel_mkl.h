#ifndef _RSVD_VORONIN_DRIVERS_H_
#define _RSVD_VORONIN_DRIVERS_H_

#include "matrix_vector_functions_intel_mkl.h"

void low_rank_svd_rand_decomp_fixed_rank_byRef(mat *M, int k, int p, int vnum, int q, int s, int *frank, mat **U, mat **S, mat **V);
